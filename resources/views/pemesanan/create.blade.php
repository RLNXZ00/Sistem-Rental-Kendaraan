                ...
                <div class="lg:col-span-4">
                    <div class="sticky top-24 bg-surface rounded-[20px] shadow-sm border border-slate-200 p-margin-mobile md:p-margin-desktop flex flex-col gap-stack-md">
                        ...
                        <div class="relative w-full aspect-[16/9] rounded-xl overflow-hidden mb-stack-sm bg-slate-100">
                            <img src="{{ isset($kendaraan) && $kendaraan->gambar_utama ? asset($kendaraan->gambar_utama) : 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=800' }}" alt="Vehicle Image" class="w-full h-full object-cover">
                        ...
                        <div>
                            <h3 class="font-headline-sm text-headline-sm text-on-surface">{{ $kendaraan->nama_kendaraan ?? 'Toyota Innova Zenix' }}</h3>
