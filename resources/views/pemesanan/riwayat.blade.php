                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg cursor-pointer"
                             @click="selectedPemesanan = {{ json_encode([
                                 'kendaraan' => $pesanan->kendaraan->nama ?? 'Kendaraan',
                            ...
                            <div class="aspect-video w-full bg-slate-100 relative">
                                <img src="https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=800" class="w-full h-full object-cover" alt="Mobil">
                            ...
                            <div class="p-4 flex flex-col gap-2">
                                <h3 class="text-xl font-bold text-slate-900" style="font-family: 'Montserrat', sans-serif;">{{ $pesanan->kendaraan->nama ?? 'Kendaraan' }}</h3>
                ...
                <div class="p-6 overflow-y-auto max-h-[70vh]">
                    <div class="flex flex-col items-center mb-6">
                        <div class="w-full aspect-video bg-slate-100 rounded-xl mb-4 overflow-hidden relative shadow-sm border border-slate-200">
                            <img src="https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=800" class="w-full h-full object-cover" alt="Vehicle">
                        </div>
