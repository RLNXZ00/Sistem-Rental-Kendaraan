            ...
            <div class="bg-surface rounded-xl p-stack-lg border border-slate-200 shadow-sm">
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-3 pb-4 border-b border-slate-100">
                        <div class="w-10 h-10 rounded-full bg-slate-100 flex-shrink-0 flex items-center justify-center text-primary font-bold">AJ</div>
                        <div>
                            <div class="flex items-center gap-2 mb-1">
                                <span class="font-label-md text-label-md text-on-background">Andi Wijaya</span>
                                <span class="text-label-sm text-outline">• 2 jam lalu</span>
                            </div>
                            <p class="text-body-sm text-on-surface-variant">"Mobil sangat bersih dan nyaman. Pelayanan admin juga cepat. Mantap!"</p>
                    ...
                    <div class="flex items-start gap-3 pb-4 border-b border-slate-100">
                        <div class="w-10 h-10 rounded-full bg-slate-100 flex-shrink-0 flex items-center justify-center text-primary font-bold">SR</div>
                        <div>
                            <div class="flex items-center gap-2 mb-1">
                                <span class="font-label-md text-label-md text-on-background">Siti Rahma</span>
                                <span class="text-label-sm text-outline">• 5 jam lalu</span>
                            </div>
                            <p class="text-body-sm text-on-surface-variant">"Proses sewa mudah tapi bensin saat diterima agak kurang dari setengah."</p>
                            <div class="flex text-[#F97316] text-sm mt-1">
                                <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">star</span>
                                <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">star</span>
                                <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">star</span>
                    ...
                    <div class="flex items-start gap-3 pb-4 border-b border-slate-100">
                        <div class="w-10 h-10 rounded-full bg-slate-100 flex-shrink-0 flex items-center justify-center text-primary font-bold">BK</div>
                        <div>
                            <div class="flex items-center gap-2 mb-1">
                                <span class="font-label-md text-label-md text-on-background">Budi Kusuma</span>
                                <span class="text-label-sm text-outline">• 1 hari lalu</span>
                            </div>
                            <p class="text-body-sm text-on-surface-variant">"Sangat direkomendasikan untuk perjalanan keluarga."</p>
                            <div class="flex text-[#F97316] text-sm mt-1">
                                <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">star</span>
                                <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">star</span>
                                <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">star</span>
